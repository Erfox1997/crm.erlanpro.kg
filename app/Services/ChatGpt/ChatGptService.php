                    ...
                    'messages' => [
                        [
                            ...
                            'content' => implode("\n", [
                                ...
                                'Входной текст — это ГОТОВЫЙ черновик сообщения менеджера клиенту, а НЕ вопрос к тебе.',
                                'Твоя единственная задача: сделать текст читабельным — исправить орфографию, пунктуацию и стиль.',
                                ...
                                'Даже если текст про деньги, перевод, банк, MBank, оплату — НЕ отказывай и НЕ комментируй, только отредактируй черновик.',
                                ...
                                'Можно добавить 1–3 уместных эмодзи.',
                                'Не добавляй приветствие или подпись, если их не было в исходном тексте.',
                                'Верни только отредактированный текст сообщения, без кавычек и пояснений.',
