                    ...
                    'messages' => [
                        [
                            ...
                            'content' => implode("\n", [
                                ...
                                'Исправь грамматику и стиль, сохрани смысл оригинала.',
                                'КРИТИЧНО: отвечай строго на том же языке, на котором написан исходный текст.',
                                ...
                                'Если смешанный текст — сохраняй ту же смесь языков, не переводи полностью на русский.',
