...
const title = computed(() =>
    isEdit.value ? t('admin.tariffs.edit') : t('admin.tariffs.create'),
);
...
<template>
    ...
    <AdminLayout>
        ...
        >
            <div>
                <InputLabel for="name" :value="t('admin.tariffs.name')" />
                <TextInput
                    id="name"
                    v-model="form.name"
            ...
            <div>
                <InputLabel
                    for="description"
                    :value="t('admin.tariffs.description')"
                />
                <TextInput
                    id="description"
                    v-model="form.description"
                    class="mt-1 block w-full"
                    :placeholder="t('admin.tariffs.descriptionPh')"
                />
            ...
            <div class="grid gap-5 sm:grid-cols-2">
                <div>
                    <InputLabel for="price" :value="t('admin.tariffs.price')" />
                    <TextInput
                        id="price"
                        v-model="form.price"
                        type="number"
                ...
                <div>
                    <InputLabel
                        for="original_price"
                        :value="t('admin.tariffs.oldPrice')"
                    />
                    <TextInput
                        id="original_price"
            ...
            <div class="grid gap-5 sm:grid-cols-2">
                <div>
                    <InputLabel
                        for="duration_days"
                        :value="t('admin.tariffs.durationDays')"
                    />
                    <TextInput
                        id="duration_days"
                ...
                <div>
                    <InputLabel
                        for="sort_order"
                        :value="t('admin.tariffs.sortOrder')"
                    />
                    <TextInput
                        id="sort_order"
            ...
            <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                <p class="text-sm font-semibold text-slate-800">
                    {{ t('admin.tariffs.limits') }}
                </p>
                <p class="mt-1 text-xs text-slate-500">
                    {{ t('admin.tariffs.limitsHint') }}
                </p>
                ...
                <div class="mt-4 grid gap-5 sm:grid-cols-2">
                    <div>
                        <InputLabel
                            for="max_employees"
                            :value="t('admin.tariffs.maxEmployees')"
                        />
                        <TextInput
                            id="max_employees"
                            ...
                            min="1"
                            class="mt-1 block w-full"
                            :placeholder="t('admin.tariffs.unlimited')"
                        />
                        <InputError
                            class="mt-2"
                    ...
                    <div>
                        <InputLabel
                            ...
                            :value="t('admin.tariffs.messageRetention')"
                        />
                        <TextInput
